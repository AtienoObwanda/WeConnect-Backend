# Generated by Django 4.0.5 on 2022-07-06 07:18
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('room1', models.CharField(blank=True, max_length=30, null=True)),
                ('room1_cover', models.ImageField(blank=True, null=True, upload_to='images/')),
                ('room1_rate', models.PositiveIntegerField(blank=True, null=True)),
                ('room2', models.CharField(blank=True, max_length=30, null=True)),
                ('room2_cover', models.ImageField(blank=True, null=True, upload_to='images/')),
                ('room2_rate', models.PositiveIntegerField(blank=True, null=True)),
                ('room3', models.CharField(blank=True, max_length=30, null=True)),
                ('room3_cover', models.ImageField(blank=True, null=True, upload_to='images/')),
                ('room3_rate', models.PositiveIntegerField(blank=True, null=True)),
                ('room4', models.CharField(blank=True, max_length=30, null=True)),
                ('room4_cover', models.ImageField(blank=True, null=True, upload_to='images/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('amount', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.rooms')),
                ('hotels', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.hotel')),
                ('user', models.ManyToManyField(related_name='bookings', to='api.customer')),
            ],
        ),
    ]
